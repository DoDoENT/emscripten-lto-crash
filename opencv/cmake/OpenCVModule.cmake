...
macro(_ocv_create_module)
  ...
  # MB patch begin
  if (BUILD_SHARED_LIBS) # MB patch
    set( mb_patch_module_suffix ${OPENCV_DLLVERSION} )
    set( mb_patch_debug_suffix  ${OPENCV_DEBUG_POSTFIX} )
  endif()
  set_target_properties(${the_module} PROPERTIES
    OUTPUT_NAME "${the_module}${mb_patch_module_suffix}" # MB patch
    DEBUG_POSTFIX "${mb_patch_debug_suffix}" # MB patch
    COMPILE_PDB_NAME "${the_module}${mb_patch_module_suffix}" # MB patch
    COMPILE_PDB_NAME_DEBUG "${the_module}${mb_patch_module_suffix}${mb_patch_debug_suffix}" # MB patch
