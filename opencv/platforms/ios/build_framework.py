...
class Builder:
    ...
    def _build(self, outdir):
        ...
        for t in self.targets:
            ...
            if xcode_ver >= 7 and t[1] == 'iPhoneOS':
                cmake_flags.append("-DCMAKE_C_FLAGS=-fembed-bitcode -fvisibility=hidden")
                cmake_flags.append("-DCMAKE_CXX_FLAGS=-fembed-bitcode -fvisibility=hidden")
    ...
    def getBuildCommand(self, arch, target):
        buildcmd = [
            "xcodebuild",
            "OTHER_CFLAGS=-fembed-bitcode -fvisibility=hidden",
